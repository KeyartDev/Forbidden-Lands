package org.keyart.forbidden_lands.common.blocks.custom.models.bakery;
...
public class BakedModelLayerFullbright extends BakedModelWrapper {
    public BakedModelLayerFullbright(BakedModel originalModel) {
        super(originalModel);
    }
